...
/* Part of 11:00 video 2 lab 6
Level.prototype.obstacleAt = function (pos, size) {
  var xStart = Math.floor (pos.x); // etc. rounds down no matter the decimal
  Already Added above
}*/
...
var gravity = 40;
var jumpSpeed = 18;
var playerYSpeed = 15; //how quickly the player moves up or down
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  var newPos = this.pos.plus(motion);
  var obstacle = level.obstacleAt(newPos, this.size); //checking any obstacle

  //check if Lava is being interacted with below
  ...
  {
    this.speed.y= 0;
    this.pos = new Vector (10,10); //need 'new Vector'
  }
  if (obstacle) {
