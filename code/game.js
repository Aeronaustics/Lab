...
var actorChars = {
  ...
  "s": Stomper //enemy to stomp down on player
};
...
function Stomper(pos){
  this.pos = this.pos = pos.plus(new Vector(0.2, 0.1));
...
Stomper.prototype.act = function(step) {
  this.stomp += step * stompSpeed;
